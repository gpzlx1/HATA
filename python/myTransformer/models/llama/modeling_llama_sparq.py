...
from ...cache.kvcache_sparq import SparQStaticCache, prepare_cache_for_generation
...
class CustomLlamaAttention(LlamaFlashAttention2):
    ...
    def forward(
        ...
        past_key_value: Optional[SparQStaticCache] = None,
...
class CustomLlamaModel(LlamaModel):
    ...
    def forward(
        ...
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
        past_key_values: Optional[SparQStaticCache] = None,
