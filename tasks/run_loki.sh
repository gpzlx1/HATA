...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 RCHANNEL=${RCHANNEL} TOPK_RATIO=${LONGBENCH_BUDGET} PCA_PATH=${LLAMA2_PCA_PATH} CUDA_MEM=17.0 NUM_RECENT=${NUM_RECENT} NUM_SINK=${NUM_SINK} python3 run_pred.py \
    ...
    --output_dir ./preds/loki-softmax-v2/longbenche_gt4K_32K-Llama-2-7B-32K-Instruct-channel${RCHANNEL}-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method loki --write_in_time --mp_num 8 --pp_num 1 --e --min_seq_len 4096
python eval_longbench_infinitebench.py --model preds/loki-softmax-v2/longbenche_gt4K_32K-Llama-2-7B-32K-Instruct-channel${RCHANNEL}-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 RCHANNEL=${RCHANNEL} TOPK_RATIO=${LONGBENCH_BUDGET} PCA_PATH=${LLAMA31_PCA_PATH} CUDA_MEM=17.0 NUM_RECENT=${NUM_RECENT} NUM_SINK=${NUM_SINK} python3 run_pred.py \
    ...
    --dataset_path ${LONGBENCH_PATH} \
    --dataset_name longbench \
    --output_dir ./preds/loki-softmax-v2/longbenche_gt4K_full-Meta-Llama-3.1-8B-Instruct-channel${RCHANNEL}-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method loki --write_in_time --mp_num 8 --pp_num 1 --e --min_seq_len 4096
python eval_longbench_infinitebench.py --model preds/loki-softmax-v2/longbenche_gt4K_full-Meta-Llama-3.1-8B-Instruct-channel${RCHANNEL}-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 RCHANNEL=${RCHANNEL} TOPK_RATIO=${LONGBENCH_BUDGET} PCA_PATH=${GLM4_PCA_PATH} CUDA_MEM=6.0 NUM_RECENT=${NUM_RECENT} NUM_SINK=${NUM_SINK} python3 run_pred.py \
    ...
    --dataset_path ${LONGBENCH_PATH} \
    --dataset_name longbench \
    --output_dir ./preds/loki-softmax-v2/longbenche_gt4K_full-glm-4-9b-chat-channel${RCHANNEL}-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method loki --write_in_time --mp_num 8 --pp_num 1 --e --min_seq_len 4096
python eval_longbench_infinitebench.py --model preds/loki-softmax-v2/longbenche_gt4K_full-glm-4-9b-chat-channel${RCHANNEL}-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 RCHANNEL=${RCHANNEL} TOPK_RATIO=${RULER_BUDGET} PCA_PATH=${GLM4_PCA_PATH} CUDA_MEM=6.0 NUM_RECENT=${NUM_RECENT} NUM_SINK=${NUM_SINK} python3 run_pred.py \
    ...
    --dataset_name ruler \
    --output_dir ./preds/loki-softmax-v2/ruler_128K-glm-4-9b-chat-channel${RCHANNEL}-top${RULER_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method loki --write_in_time --mp_num 8 --pp_num 1 --min_seq_len 0
python eval_ruler.py --model preds/loki-softmax-v2/ruler_128K-glm-4-9b-chat-channel${RCHANNEL}-top${RULER_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 RCHANNEL=${RCHANNEL} TOPK_RATIO=${RULER_BUDGET} PCA_PATH=${LLAMA31_PCA_PATH} CUDA_MEM=17.0 NUM_RECENT=${NUM_RECENT} NUM_SINK=${NUM_SINK} python3 run_pred.py \
    ...
    --dataset_name ruler \
    --output_dir ./preds/loki-softmax-v2/ruler_128K-Meta-Llama-3.1-8B-Instruct-channel${RCHANNEL}-top${RULER_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method loki --write_in_time --mp_num 4 --pp_num 2 --min_seq_len 0
python eval_ruler.py --model preds/loki-softmax-v2/ruler_128K-Meta-Llama-3.1-8B-Instruct-channel${RCHANNEL}-top${RULER_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
