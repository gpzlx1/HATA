...
def _choose_sample_by_score(samples: List[Sample],
                            key: str) -> Optional[Sample]:
    if len(samples) == 0:
        return None
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        '/root/workspace/myoffloading/myTransformer/tasks/preds/flashattn/math500-Meta-Llama-3.1-8B-Instruct'
    )
    ...
    for filename in all_files:
        ...
        for sample in samples:
            ...
            is_correct = grade_answer(extracted_answer, answer)
            total += 1
            acc += is_correct
        score = acc / total * 100
