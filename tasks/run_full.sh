...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 CUDA_MEM=17.0 python3 run_pred.py \
    ...
    --output_dir ./preds/flashattn/longbenche_gt4K_full-Meta-Llama-3.1-8B-Instruct-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method flashattn --write_in_time --mp_num 8 --pp_num 1 --e --min_seq_len 4096
python eval_longbench_infinitebench.py --model preds/flashattn/longbenche_gt4K_full-Meta-Llama-3.1-8B-Instruct-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 CUDA_MEM=6.0 python3 run_pred.py \
    ...
    --dataset_path ${LONGBENCH_PATH} \
    --dataset_name longbench \
    --output_dir ./preds/flashattn/longbenche_gt4K_full-glm-4-9b-chat-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method flashattn --write_in_time --mp_num 8 --pp_num 1 --e --min_seq_len 4096
python eval_longbench_infinitebench.py --model preds/flashattn/longbenche_gt4K_full-glm-4-9b-chat-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 CUDA_MEM=17.0 python3 run_pred.py \
    ...
    --dataset_path ${LONGBENCH_PATH} \
    --dataset_name longbench \
    --output_dir ./preds/flashattn/longbenche_gt4K_32K-Llama-2-7B-32K-Instruct-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}/ \
    --method flashattn --write_in_time --mp_num 8 --pp_num 1 --e --min_seq_len 4096
python eval_longbench_infinitebench.py --model preds/flashattn/longbenche_gt4K_32K-Llama-2-7B-32K-Instruct-top${LONGBENCH_BUDGET}-sink${NUM_SINK}-recent${NUM_RECENT}
