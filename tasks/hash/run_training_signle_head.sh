...
#     --save_path /root/workspace/myoffloading/model_weights_v4_single_head/Meta-Llama-3.1-8B-Instruct-128 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights_single_head.py \
    ...
    --save_path /root/workspace/myoffloading/model_weights_v4_single_head/glm-4-9b-chat-128-v2 \
