...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights.py \
    ...
    --save_path /root/workspace/myoffloading/model_weights_v5/Meta-Llama-3.1-8B-Instruct-128-v2 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights.py \
    ...
    --save_path /root/workspace/myoffloading/model_weights_v5/glm-4-9b-chat-128 \
