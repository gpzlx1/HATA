...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights.py \
    ...
    --save_path /root/workspace/myoffloading/model_weights_v5/Meta-Llama-3.1-8B-Instruct-128 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights.py \
    ...
    --save_path /root/workspace/myoffloading/model_weights_v5/Llama-2-7B-32K-Instruct-128 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights.py \
    --dataset_path /mnt/ramdisk/Qwen2.5-14B-Instruct-1M \
    --save_path /root/workspace/myoffloading/model_weights_v5/Qwen2.5-14B-Instruct-1M-128 \
    --num_layers 48 --num_skip_layers 2 --num_heads 40 --num_kv_heads 8 \
    --head_dim 128 --rbit 128 --chunk_num 3 --mp_num 8 \
    --train_epochs 15 --train_iters 20 --rep_iters 10 --lr 0.1 \
    --epsilon 0.01 --lambdda 1.0 --eta 2.0 --sigma 0.1
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python learn_hash_weights.py \
    --dataset_path /mnt/ramdisk/Qwen2.5-32B-Instruct \
    --save_path /root/workspace/myoffloading/model_weights_v5/Qwen2.5-32B-Instruct-128 \
    --num_layers 28 --num_skip_layers 2 --num_heads 28 --num_kv_heads 4 \
    --head_dim 128 --rbit 128 --chunk_num 3 --mp_num 8 \
    --train_epochs 15 --train_iters 20 --rep_iters 10 --lr 0.1 \
    --epsilon 0.01 --lambdda 1.0 --eta 2.0 --sigma 0.1
