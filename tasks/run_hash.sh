...
# LLAMA31_HASH_WEIGHTS_PATH=../weights/Meta-Llama-3.1-8B-Instruct-${RBIT}
# LLAMA2_HASH_WEIGHTS_PATH=../weights/Llama-2-7B-32K-Instruct-${RBIT}

CUDA_VISIBLE_DEVICES=7 python3 run_pred.py \
    --model_name Qwen2.5-7B-Instruct-1M \
    --model_name_or_path ${QWEN2_PATH} \
    --model_maxlen 130816 \
    --dataset_path ${LONGBENCH_PATH} \
    --config_file /workspace/HATA/configs/hash_qwen2.5_longbench-e.ini \
    --dataset_name longbench \
    --output_dir ./preds/test \
    --method flashattn --write_in_time --mp_num 1 --pp_num 1 --min_seq_len 0 --e
...
#     --model_maxlen 130816 \
#     --dataset_path ${LONGBENCH_PATH} \
#     --config_file /workspace/HATA/configs/hash_llama3.1_longbench-e.ini \
#     --dataset_name longbench \
