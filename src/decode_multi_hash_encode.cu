...
extern "C" {
#include "decode_multi_hash_encode_rbit128_dim128.h"
#include "decode_multi_hash_encode_rbit256_dim128.h"
}
...
void decode_multi_hash_encode(torch::Tensor key_data, torch::Tensor hash_weights,
  ...
  if (rbit == 128) {
    _decode_multi_hash_encode_rbit128_dim128_kernel_a44367f2_0123456789101112131415(
    ...
    _decode_multi_hash_encode_rbit256_dim128_kernel_17940b89_0123456789101112131415(
        stream, key_data_ptr, key_data_stride0, query_data_ptr,
        query_data_stride0, hash_weight_ptr, packbit_tensor_ptr,
        key_code_output_ptr, key_code_output_stride0, key_norm_output_ptr,
        key_norm_output_stride0, query_code_output_ptr,
